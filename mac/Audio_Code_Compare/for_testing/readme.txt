...
================================
-run_Audio_Code_Compare.sh (shell script for temporarily setting environment variables 
 and executing the application)
   -to run the shell script, type
   
       ./run_Audio_Code_Compare.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v94, run the shell script as:
       ...
       ./run_Audio_Code_Compare.sh /mathworks/home/application/v94
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_Audio_Code_Compare.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure Audio_Code_Compare.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r Audio_Code_Compare.zip Audio_Code_Compare.app
    or the tar command 
    tar -cvf Audio_Code_Compare.tar Audio_Code_Compare.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v94/runtime/maci64:MR/v94/sys/os/maci64:MR/v94/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_Audio_Code_Compare.sh 
